# Generated by Django 5.0.7 on 2024-11-09 06:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_role', models.CharField(choices=[('Пользователь', 'Пользователь'), ('Владелец_отеля', 'Владелец_отеля'), ('admin', 'admin')], default='Пользователь', max_length=32)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room_type', models.CharField(choices=[('люкс', 'люкс'), ('семейный', 'семейный'), ('одноместный', 'одноместный')], default='свободен', max_length=16)),
                ('room_status', models.CharField(choices=[('свободен', 'свободен'), ('забронирован', 'забронирован'), ('занят', 'занят')], default='свободен', max_length=15)),
